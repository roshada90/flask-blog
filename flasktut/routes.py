...
from flasktut import app, db, bcrypt, mail
...
def register():
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        flash(
            f'Account created for {form.username.data}! You can Login',
            'success')
...
# display individual users posts
...
def send_reset_email(user):
    ...
    msg = Message('Password Reset Request',
                  sender='no_reply@gmail.com', recipients=[user.email])
...
def reset_token(token):
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        flash(
            f'Password has been reset for {form.username.data}! You can Login',
            'success')
        return redirect(url_for('login'))
